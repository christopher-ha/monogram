...
export default function API() {
  return (
    <section className="relative bg-neutral-900 text-center">
      ...
      {/* 3D Sphere */}
      <section className="absolute -bottom-64 z-20 flex aspect-square w-screen flex-col items-center md:-bottom-[32rem] lg:-bottom-[42rem] lg:left-1/2 lg:mx-auto lg:aspect-auto lg:h-screen lg:max-w-screen-2xl lg:-translate-x-1/2">
        <Experience />
      </section>
    </section>
  );
